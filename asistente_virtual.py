...
id4 = 'HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Speech\Voices\Tokens\TTS_MS_EN-GB_HAZEL_11.0'

# escuacharmicrofono y devolver el auidio como texto
def transformar_audio_en_texto():
    ...
    with sr.Microphone() as origen:
        ...
        # en caso de que no comprenda el audio
            ...
            # en caso ed que no comprenda el audio
...
def saludo_inicial():
    ...
    # decir saludo
    hablar(f'{momento}, soy Urano, tu asistente personal. Por Favor dime en que te puedo ayudar')
...
def pedir_cosas():
    ...
    while comenzar:
        ...
        # acticar el micro y guardar el pedido en un string
        ...
        if 'abrir youtube' in pedido:
            ...
            hablar('Buscando es en wikipedia')
            ...
            hablar("Nos vemos pronto, Gastón")
            break 
